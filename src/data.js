...
export const UNIV_NAMES = {
  ...
  toronto:  { en: 'University of Toronto', fr: 'Université de Toronto' },
...
export const LEVELS_DATA = {
  bachelor: {
    ...
    toronto:  { 2019: 16595, 2020: 18423, 2021: 19622, 2022: 20013, 2023: 20832 },
  ...
  master: {
    ...
    toronto:  { 2019: 2280, 2020: 2297, 2021: 2712, 2022: 3248, 2023: 3495 },
  ...
  doctoral: {
    ...
    toronto:  { 2019: 1636, 2020: 1841, 2021: 2126, 2022: 2085, 2023: 2191 },
...
export const LINE_Y_MAX = 28000;
export const BAR_Y_MAX = 24000;
...
export const T = {
  fr: {
    ...
    langLabel: 'English',
    brand: 'UTrack',
    tagline: 'Étudiants internationaux dans les 6 meilleures universités ontariennes',
    description: 'Évolution et répartition des étudiants internationaux',
    source: 'Source : CUDO (Council of Ontario Universities), QS World University Rankings 2026',
  ...
  en: {
    ...
    langLabel: 'Français',
    brand: 'UTrack',
    tagline: "International Students in Ontario's Top 6 Universities",
    description: 'Trends and breakdown of international student enrolment',
    source: 'Source: CUDO (Council of Ontario Universities), QS World University Rankings 2026',
